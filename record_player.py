...
class recordPlayer():
    ...
    def on(self):
        ...
        if self.proc is None:
            ...
            proc = subprocess.Popen("echo ' ' > ~/.config/pianobar/ctl", shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
    ...
    def next(self):
        # SKIP SONG
        if self.proc is not None:
            proc = subprocess.Popen("echo 'n' > ~/.config/pianobar/ctl", shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
    ...
    def quit_player(self):
        ...
        proc = subprocess.Popen("echo 'q' > ~/.config/pianobar/ctl", shell=True, stdin=subprocess.PIPE, stdout=subprocess.PIPE)
